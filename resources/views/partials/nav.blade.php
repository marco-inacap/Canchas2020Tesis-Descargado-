...
<nav class="custom-wrapper" id="menu">
    ...
    <ul class="container-flex list-unstyled">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            @guest
            <li>
                <a href="{{ route('users.register') }}" class="text-uppercase {{ request()->routeIs('users.register') ? 'active' : ''}}">Registrarme</a>
            </li>  
            <li>
                <a href="{{ route('loginuser') }}" class="text-uppercase {{ request()->routeIs('loginuser') ? 'active' : ''}}">Login</a>
            </li>
            @else
                <li class="dropdown">
                    <a href="#" class="text-uppercase" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true" v-pre>
