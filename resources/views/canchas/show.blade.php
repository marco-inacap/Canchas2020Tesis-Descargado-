        ...
        <footer class="container-flex space-between">
          ...
          <div class="buttons-social-media-share">
             <ul class="share-buttons">
              ...
              {{-- <li><a href="https://twitter.com/intent/tweet?url={{ request()->fullUrl()}}&text={{$cancha->nombre}}&i={{$cancha->photos->url}}&via=SuCancha&hashtags=canchas" target="_blank" title="Tweet"><img alt="Tweet" src="/img/flat_web_icon_set/Twitter.png"></a></li>  --}} 
          ...
          <div class="footer">
            ...
            @else
                <a href="{{ route('canchas.undislike', $cancha) }}"><i class="fas fa-thumbs-down dislike nomegusta puntero"></i></a>
                <span class="alert-info">{{ $cancha->dislikesCount }}</span>
            @endif
        </div>
      </footer>
