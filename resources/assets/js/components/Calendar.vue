...
export default {
  ...
  created: function() {
    this.cancha_id = localStorage.cancha_id;
  ...
  methods: {
        ...
        axios({
          ...
          .then(res => {
              ...
              this.$notify({
                ...
                text: "Se reservo la cancha exitosamente",
                type: "success",
                duration: 5000,
              });
            }
          ...
          .catch(error => {
            ...
            this.$notify({
              group: "notificacion",
              title: "Error al reservar esta cancha",
              text: "Ocurrio un error al reservar la cancha",
              type: "error"
            });
          });
      }
    ...
    cargarEventos(mes) {
      ...
      axios
        .request({
          url: `/api/reserva/${this.cancha_id}/ambiente/${mes}/mes`,
          method: "get",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`
          }
        ...
        .catch(error => {
          ...
          this.$router.push({ path: "lista-canchas" });
        });
    },
