<div class="slider">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2>Lea los comentarios de nuestros clientes.</h2>
                <p class="p-heading">Nuestros clientes son nuestros socios y no podemos imaginar un futuro mejor para nuestra empresa sin ayudarlos a alcanzar sus objetivos.</p>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
        <div class="row">
            <div class="col-lg-12">
