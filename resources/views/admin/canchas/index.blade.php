...
<div class="box box-primary">
  <div class="box-header">
    ...
    @can('Create Cancha')
    <div class="button btn btn-primary pull-right" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>
      Crear Cancha</div>
    @endcan
  </div>
  <!-- /.box-header -->
          ...
          <tr>
            ...
            <td>
              ...
              <form method="POST" action="{{route('admin.canchas.destroy', $cancha)}}" style="display: inline">
                ...
                <button class="btn-xs btn-danger" onclick="return confirm('¿Estas seguro de eliminar esta cancha?')"><i
        ...
        <div class="modal-body">
          <div class="box-body">
            <div class="form-group {{$errors->has('nombre') ? 'has-error':''}}">
              ...
              <input name="nombre" type="text" class="form-control" placeholder="Ingresa aquí el nombre de la Cancha"
